  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE aircrafts (
        ...
        engine1_hours VARCHAR(100) NULL,
        engine1_n1 INT(10) NULL,
        engine1_n2 INT(10)  NULL,
        engine1_imp INT(10) NULL,
        engine2_hours VARCHAR(100) NULL,
        engine2_n1 INT(10) NULL,
        engine2_n2 INT(10) NULL,
        engine2_imp INT(10) NULL,
        empyt_weight INT(10) NULL,
