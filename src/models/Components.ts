...
import { ComponentsEvaluations } from "./ComponentsEvaluations";
...
export class Components {
  ...
  @OneToMany(
    ...
    (componentsEvaluations) => componentsEvaluations.components
  )
  componentsEvaluations: ComponentsEvaluations[];
}
